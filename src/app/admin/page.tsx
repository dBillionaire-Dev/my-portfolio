...
export default function Admin() {
  ...
  }, [user, isAuthLoading, isClient, router]);

  if (!isClient || isAuthLoading) return <div className="min-h-screen flex items-center justify-center"><Loader2 className="animate-spin" /></div>;
  if (!user) return null;
