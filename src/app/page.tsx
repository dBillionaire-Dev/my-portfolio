...
export default async function Home() {
  ...
  const featuredProjects = projects?.filter((p: any) => p.featured).sort((a: any, b: any) => (b.priority || 0) - (a.priority || 0)) || [];
      ...
      <main className="pt-32 pb-20 px-6 md:px-12 max-w-7xl mx-auto">
        ...
        <section className="py-20">
          <div className="flex items-end justify-between mb-12">
            ...
            <Link href="/projects" className="hidden md:flex items-center gap-2 text-sm font-medium hover:gap-3 transition-all">
