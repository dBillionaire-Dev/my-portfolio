          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-bold tracking-tighter mb-8 leading-[0.9]">
                Building digital <br/>
                <span className="text-zinc-500">architectures that</span> <br/>
                scale.
              </h1>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4">
                <div className="bg-white/5 p-4 rounded-xl border border-white/5 flex-1">
                  <div className="text-primary font-bold text-2xl mb-1">5+</div>
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="bg-white/5 p-8 rounded-2xl border border-white/5 group hover:border-primary/20 transition-colors">
                ...
                <p className="text-sm text-muted-foreground">
                  Node.js, Go, Rust, and Python. Expert in building low-latency APIs and microservices.
                </p>
              </div>
              <div className="bg-white/5 p-8 rounded-2xl border border-white/5 group hover:border-primary/20 transition-colors">
                <div className="flex items-center gap-4 mb-4 text-primary">
                ...
                <p className="text-sm text-muted-foreground">
                  PostgreSQL, Redis, Vector DBs (Pinecone, Weaviate). Scalable schema design.
                </p>
              </div>
              <div className="bg-white/5 p-8 rounded-2xl border border-white/5 group hover:border-primary/20 transition-colors">
                <div className="flex items-center gap-4 mb-4 text-primary">
        ...
        <section className="py-20 border-t border-white/5">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 opacity-50">
            <div className="flex items-center gap-3">
              ...
              <span className="font-mono text-sm">React / Next.js</span>
            </div>
            <div className="flex items-center gap-3">
              <Terminal className="w-6 h-6" />
